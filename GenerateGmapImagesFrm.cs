...
{
    public partial class GenerateGmapImagesFrm : Form
    {
        private static string kpath = "Survey\\SHM\\QRC";

        public GenerateGmapImagesFrm()
        {
            InitializeComponent();
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            tbCoords.Text = Interaction.GetSetting(typeof(GenerateGmapImagesFrm).Namespace, "Settings", tbCoords.Name, "569415.64	1259283.89");
            VNProvs.Text = Interaction.GetSetting(typeof(GenerateGmapImagesFrm).Namespace, "Settings", VNProvs.Name, VNProvinces.Datas.FirstOrDefault());
            cbSize.Text = Interaction.GetSetting(typeof(GenerateGmapImagesFrm).Namespace, "Settings", cbSize.Name, "1000x500");
        ...
        {
            Interaction.SaveSetting(typeof(GenerateGmapImagesFrm).Namespace, "Settings", tbCoords.Name, tbCoords.Text);
            Interaction.SaveSetting(typeof(GenerateGmapImagesFrm).Namespace, "Settings", VNProvs.Name, VNProvs.Text);
            Interaction.SaveSetting(typeof(GenerateGmapImagesFrm).Namespace, "Settings", cbSize.Name, cbSize.Text);
        }
